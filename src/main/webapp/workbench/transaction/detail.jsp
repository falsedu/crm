...
<%@ page import="com.dcm.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="com.dcm.crm.settings.domain.DicType" %>
<%@ page import="com.dcm.crm.workbench.domain.Tran" %>
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		String currstage=t.getStage();
		String curposs=t.getPossibility();
	...
	%>
		...
		<%
					...
					%>
		<span id="<%=i%>" onclick="changeStage('<%=listStage%>','<%=i%>')"
			  class="glyphicon glyphicon-remove mystage"  style="color: black;"
			  data-toggle="popover" data-placement="bottom"
			  data-content="<%=dv.getText()%>" ></span>
		-----------
		<%
					...
					%>
		<span id="<%=i%>" onclick="changeStage('<%=listStage%>','<%=i%>')"
			  class="glyphicon glyphicon-record mystage" style="color: black;"
			  data-toggle="popover" data-placement="bottom"
			  data-content="<%=dv.getText()%>" ></span>
		-----------
...
<%--		<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="因竞争丢失关闭"></span>--%>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b id="poss">${t.possibility}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
