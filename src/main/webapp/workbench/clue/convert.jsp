...
<%--							</tr>--%>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
			<input id="clueId" type="hidden" name="cid" value="${param.id}">
			<input id="needTran" type="hidden" name="needTran" value="a">
...
<%--		    	<option>因竞争丢失关闭</option>--%>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="activitySearchBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
		    <input type="text" class="form-control" id="activityName" placeholder="点击上面搜索" readonly>
			  <input type="hidden" id="activityId" name="aid"/>
		  </div>
		</form>
