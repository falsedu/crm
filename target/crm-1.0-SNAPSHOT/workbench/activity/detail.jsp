				...
				$.ajax({
					...
					success:function (data) {
						if(data.success==true){
							...
							html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id=timeby'+data.remark.id+'> '+(data.remark.editFlag==0?data.remark.createTime :data.remark.editTime) +'由'+(data.remark.editFlag==0?data.remark.createBy :data.remark.editBy)+'</small>';
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id=timeby'+n.id+'> '+(n.editFlag==0?n.createTime :n.editTime) +'由'+(n.editFlag==0?n.createBy :n.editBy)+'</small>';
					html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
			...
			$.ajax({
				...
				success:function (data) {
					if(data.success){
						...
						var html=(data.remark.editFlag==0?data.remark.createTime :data.remark.editTime) +'由'+(data.remark.editFlag==0?data.remark.createBy :data.remark.editBy);
